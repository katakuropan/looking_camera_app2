...
- Marked the `pytorch_lightning.utiltiies.distirbuted.register_ddp_comm_hook` function as protected ([#17009](https://github.com/Lightning-AI/lightning/pull/17009))
...
- Deprecated `pytorch_lightning.lite.LightningLite` in favor of `lightning_fabric.Fabric` ([#16314](https://github.com/Lightning-AI/lightning/pull/16314))
